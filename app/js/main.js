...
var _song_model = require('./song_model');

var _song_model2 = _interopRequireDefault(_song_model);

var _song_collection = require('./song_collection');
...
var SongCollection = _backbone2['default'].Collection.extend({

  url: 'https://api.parse.com/1/classes/top40songs',

  model: _song_model2['default'],
...
var SongModel = _backbone2['default'].Model.extend({
